...
namespace CodeFirstExample.Controllers
{
    ...
    {
        private readonly CFActsDec23Context _context;

        public DepartmentsController(CFActsDec23Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departments != null ? 
                          ...
                          Problem("Entity set 'CFActsDec23Context.Departments'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CFActsDec23Context.Departments'  is null.");
            }
            var department = await _context.Departments.FindAsync(id);
            if (department != null)
            {
