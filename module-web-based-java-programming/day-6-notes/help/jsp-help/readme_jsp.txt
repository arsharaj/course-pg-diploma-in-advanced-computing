...
....
2. To add private attributes , available ONLY to current page
...
pageContext --- instance of PageContext's sub class in jasper.jar
...
1. import="comma separated list of pkgs or pkged clasess"
...
errorPage="URI of err handling page" 
tells WC to forward user to err handler page , in case of errors.
4. isErrorPage="true|false" default = false
