...
Important : 
JVM creates an immutable instance of java.lang.Class , per every loaded class in method area , which provides methods to examine the runtime properties of the object and create new objects, invoke its method and get/set object fields.
