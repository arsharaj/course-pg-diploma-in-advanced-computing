...
// String object is immutable by default and thus we provide
// 
public class Test2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb1.length() + " " + sb1.capacity());
		// In this case the capacity would not be 0 for that purpose
		// we have to trim the size of our string builder object.
